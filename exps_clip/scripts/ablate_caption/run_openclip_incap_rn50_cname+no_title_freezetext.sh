...
torchrun --nproc_per_node 4 --master_port=$MASTER_PORT -m training.main \
    --model RN50 \
    --train-data ../datasets/imagenet-captions/incaps_tags_description_cname_448896.tsv \
    --dataset-type csv \
    ...
    --nc_metrics \
    --logs ./logs \
    --name RN50-lr_0.001-b_1024-e_32-p_amp-freezetext_clip_wit400m-text_no_title